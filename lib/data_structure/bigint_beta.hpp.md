...
data:
  ...
  code: "#include \"fft/ntt.hpp\"\r\n#include \"template/template.hpp\"\r\n\r\n/*\r\
    ...
    \ BigInt &rhs) {\r\n        static constexpr int mod = 469762049;  // 2^26 * 7\
    \ + 1\r\n        NTT<mod, 3> ntt;\r\n        ntt.convolution_self(data, rhs.data);\r\
    ...
    \ }\r\n\r\n    int back() const {\r\n        assert(data.size() > 0);\r\n    \
    \    return data.back();\r\n    }\r\n\r\n    bool is_negative() const { return\
    \ back() < 0; }\r\n\r\n    inline bool is_zero() const { return data.size() ==\
    \ 1 && data[0] == 0; }\r\n\r\n    void format() {\r\n        while (size() > 1\
    \ && back() == 0) data.pop_back();\r\n        bool flg = is_negative();\r\n  \
...
layout: document
redirect_from:
- /library/lib/data_structure/bigint_beta.hpp
- /library/lib/data_structure/bigint_beta.hpp.html
