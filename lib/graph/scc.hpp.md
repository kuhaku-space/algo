...
data:
  ...
  code: "#include \"graph/graph.hpp\"\r\n#include \"template/template.hpp\"\r\n\r\n\
    ...
    \ order.end());\r\n    int ptr = 0;\r\n    for (auto i : order) {\r\n        if\
    \ (comp[i] == -1) rdfs(rdfs, i, ptr++);\r\n    }\r\n\r\n    return comp;\r\n};\r\
    \n\r\n/**\r\n * @brief \u6709\u5411\u975E\u5DE1\u56DE\u30B0\u30E9\u30D5\u306E\u69CB\
    \u7BC9\r\n *\r\n * @tparam T \u8FBA\u306E\u91CD\u307F\u306E\u578B\r\n * @param\
    \ g \u30B0\u30E9\u30D5\r\n * @param v \u5404\u9802\u70B9\u304C\u5C5E\u3059\u308B\
    \u5F37\u9023\u7D50\u6210\u5206\u306E\u756A\u53F7\r\n * @return Graph<T> \u6709\
    \u5411\u975E\u5DE1\u56DE\u30B0\u30E9\u30D5\r\n */\r\ntemplate <class T>\r\nGraph<T>\
    \ make_DAG(const Graph<T> &g, const vector<int> &v) {\r\n    Graph<T> res(*std::max_element(v.begin(),\
    \ v.end()) + 1);\r\n    for (auto &es : g) {\r\n        for (auto &e : es) {\r\
    ...
    \   int n = g.size();\r\n    Graph<void> res(*std::max_element(v.begin(), v.end())\
    \ + 1);\r\n    for (int i = 0; i < n; ++i) {\r\n        for (auto &e : g[i]) {\r\
    \n            int x = v[i], y = v[e];\r\n            if (x != y) res.add_edge(x,\
    \ y);\r\n        }\r\n    }\r\n    return res;\r\n}\r\n"
  dependsOn:
  ...
  timestamp: '2022-03-05 12:18:57+09:00'
