...
data:
  ...
  bundledCode: "#line 1 \"lib/math/eratosthenes.hpp\"\n#include <array>\r\n#include\
    \ <cmath>\r\n#include <cstdint>\r\n#include <vector>\r\n\r\n/**\r\n * @brief \u30A8\
    ...
    \ i = 3; i <= x; i += 2) {\r\n            if (is_prime(i)) res.emplace_back(i);\r\
