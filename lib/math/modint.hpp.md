...
data:
  ...
  code: "#pragma once\r\n#include \"internal/internal_math.hpp\"\r\n#include \"internal/internal_type_traits.hpp\"\
    ...
    \n    }\r\n    constexpr mint &operator/=(const mint &rhs) { return *this = *this\
    \ * rhs.inv(); }\r\n\r\n    constexpr mint operator+() const { return *this; }\r\
    ...
    \ == 1);\r\n            return eg.second;\r\n        }\r\n    }\r\n\r\n    friend\
    \ constexpr mint operator+(const mint &lhs, const mint &rhs) { return mint(lhs)\
    ...
    \ &operator>>(std::istream &is, mint &rhs) {\r\n        std::int64_t t;\r\n  \
    \      is >> t;\r\n        rhs = mint(t);\r\n        return is;\r\n    }\r\n \
    ...
    \ v) {\r\n        std::int64_t x = (std::int64_t)(v % (std::int64_t)(mod()));\r\
    \n        if (x < 0) x += mod();\r\n        _v = (unsigned int)(x);\r\n    }\r\
    ...
    \ dynamic_modint<id>::bt(998244353);\r\n\r\nusing modint998 = static_modint<998244353>;\r\
    ...
    \r\ntemplate <class>\r\nstruct is_dynamic_modint : public std::false_type {};\r\
