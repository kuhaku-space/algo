...
data:
  ...
  code: "#include \"template/template.hpp\"\r\n\r\n/**\r\n * @brief \u7D20\u6570\u30E9\
    \u30A4\u30D6\u30E9\u30EA\r\n *\r\n * @tparam N\r\n */\r\ntemplate <int N = 1 <<\
    \ 22>\r\nstruct prime_number {\r\n    prime_number() : is_not_prime(), data()\
    \ { this->init(); }\r\n\r\n    /**\r\n     * @brief \u7D20\u6570\u5224\u5B9A\r\
    \n     *\r\n     * @param n\r\n     * @return bool\r\n     */\r\n    bool is_prime(std::int64_t\
    \ n) const {\r\n        assert(n >= 0);\r\n        if (n < N) return !this->is_not_prime[n];\r\
    ...
    \ res.begin() + n * i, res.begin() + n * (i + 1));\r\n            }\r\n      \
    \  }\r\n        return res;\r\n    }\r\n\r\n    /**\r\n     * @brief \u56E0\u6570\
    \u5206\u89E3\u5217\u6319\r\n     *\r\n     * @tparam T\r\n     * @param x\r\n\
    \     * @return std::vector<std::vector<T>>\r\n     */\r\n    template <class\
    \ T>\r\n    std::vector<std::vector<T>> factorization(T x) const {\r\n       \
    \ std::vector<std::vector<T>> res;\r\n        auto f = [&](auto self, std::vector<T>\
