...
data:
  ...
  code: "#include \"template/template.hpp\"\r\n\r\n/**\r\n * @brief \u53CC\u5BFE\u30BB\
    ...
    \ i < n; ++i) this->data[this->N + i] = v[i];\r\n    }\r\n\r\n    void update(int\
    \ k, T x) {\r\n        int l = 0;\r\n        while (k >> l > 1) ++l;\r\n     \
    \   for (; l > 0; --l) {\r\n            int t = k >> l;\r\n            if (this->data[t]\
    \ == e) continue;\r\n            this->data[t * 2] = this->f(this->data[t], this->data[t\
    \ * 2]);\r\n            this->data[t * 2 + 1] = this->f(this->data[t], this->data[t\
    \ * 2 + 1]);\r\n            this->data[t] = e;\r\n        }\r\n        this->data[k]\
  ...
  verifiedWith: []
documentation_of: lib/segment_tree/dual_segment_tree_virtual.hpp
layout: document
redirect_from:
- /library/lib/segment_tree/dual_segment_tree_virtual.hpp
- /library/lib/segment_tree/dual_segment_tree_virtual.hpp.html
title: "\u53CC\u5BFE\u30BB\u30B0\u30E1\u30F3\u30C8\u6728"
---
