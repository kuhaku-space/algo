...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/opt/hostedtoolcache/Python/3.10.14/x64/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    )\nonlinejudge_verify.languages.cplusplus_bundle.BundleErrorAt: tree/dsu_on_tree.hpp:\
  ...
  verifiedWith: []
documentation_of: test/aoj/jag/dsu_on_tree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/jag/dsu_on_tree.test.cpp
- /verify/test/aoj/jag/dsu_on_tree.test.cpp.html
